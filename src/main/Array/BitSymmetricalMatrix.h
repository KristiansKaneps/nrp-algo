...
namespace BitMatrix {
    ...
    public:
        explicit BitSymmetricalMatrix(const dimension_size_t dimensionSize) : m_DimensionSize(dimensionSize),
                                                                              m_Array(
    ...
    protected:
        ...
        [[nodiscard]] std::pair<dimension_size_t, dimension_size_t> invertIndex(const array_size_t index) const {
    ...
    BitSymmetricalMatrix createSymmetricalMatrix(array_size_t dimensionSize);
    BitSymmetricalMatrix createIdentitySymmetricalMatrix(array_size_t dimensionSize);
}
